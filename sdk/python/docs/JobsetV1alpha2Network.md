...
**publish_not_ready_addresses** | **bool** | PublishNotReadyAddresses indicates that any agent which deals with endpoints for the underlying Headless Service should disregard any indications of ready/not-ready. Defaults to true if not set. | [optional] 
