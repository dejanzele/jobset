...
class JobsetV1alpha2Network(object):
    ...
    def publish_not_ready_addresses(self):
        ...
        PublishNotReadyAddresses indicates that any agent which deals with endpoints for the underlying Headless Service should disregard any indications of ready/not-ready. Defaults to true if not set.  # noqa: E501
