			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"publishNotReadyAddresses": {
						SchemaProps: spec.SchemaProps{
							Description: "PublishNotReadyAddresses indicates that any agent which deals with endpoints for the underlying Headless Service should disregard any indications of ready/not-ready. Defaults to true if not set.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
